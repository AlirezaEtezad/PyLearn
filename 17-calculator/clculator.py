...
window.btn_1.clicked.connect(one)
window.btn_2.clicked.connect(two)
window.btn_3.clicked.connect(three)
window.btn_4.clicked.connect(four)
window.btn_5.clicked.connect(five)
window.btn_6.clicked.connect(six)
window.btn_7.clicked.connect(seven)
window.btn_8.clicked.connect(eight)
window.btn_9.clicked.connect(nine)
window.btn_0.clicked.connect(zero)
